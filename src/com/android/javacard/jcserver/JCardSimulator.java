...
public class JCardSimulator implements Simulator {
  ...
  private boolean provisionCmd(CardSimulator simulator) {
    ...
    short keyBlobPtr = KMByteBlob.instance(byteBlob, (short) 0,
            (short) byteBlob.length);
  ...
  private boolean setBootParams(CardSimulator simulator) {
    ...
    // short patchTagPtr = KMIntegerTag.instance(KMType.UINT_TAG,
    // KMType.OS_PATCH_LEVEL, versionPatchPtr);
