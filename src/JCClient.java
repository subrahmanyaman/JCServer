	...
	public static void main(String[] args) {
		try {
			...
			if(sock.isConnected()) {
				...
				os.write(Utils.hexStringToByteArray("801140002283A21A2000000441011A200000064140035000000000000000000000000000000000007F"));
				...
				System.out.println("Response from server "+ Utils.byteArrayToHexString(inBytes)+ " length: "+inBytes.length);
				}
			}
		} catch (IOException e) {
